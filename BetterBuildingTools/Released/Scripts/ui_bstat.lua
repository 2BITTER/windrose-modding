...
local function create(H)
    ...
    function BStat.Update()
        ...
        if not s or not s.inBuildModeVisual then
    ...
    function BStat.Build()
        ...
        H.MakeDivider(vbox, "BBTDivBot")
        H.MakeTextBlock(vbox, "BBTInfoLine", H.BS(8),
            "Data updates while in build mode",
            H.COLOR_DIM, { Left = 0, Top = 0, Right = 0, Bottom = 0 })
